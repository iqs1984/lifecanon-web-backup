        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a href="{{ route('page.create') }}" class="btn btn-neutral">Add New Page</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col">
            <div class="card bg-default shadow">
                <div class="card-header bg-transparent border-0">
                    <h3 class="text-white mb-0">Page Information</h3>
                    @if(session('success'))
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-dark table-flush">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('page.edit', $datas->id) }}" class="text-white">
                                    <span class="mr-2"><i class="fa fa-edit" title="Edit User"></i></span>
                                </a>
                                <span> {!! Form::open([
                                          'method'=>'DELETE',
                                          'route' => ['page.destroy', $datas->id],
                                          ...
                                          'class' => 'btn',
                                          'title' => 'Delete Page',
                                          'onclick'=>'return confirm("Are you sure about deleting Page?")'
                                          )) !!}
                                          {!! Form::close() !!}</span>
                            </td>
                        </tr>
