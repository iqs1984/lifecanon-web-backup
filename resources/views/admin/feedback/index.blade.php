        ...
        <div class="col">
            <div class="card bg-default shadow">
                <div class="card-header bg-transparent border-0">
                    <h3 class="text-white mb-0">Feedback Information</h3>
                    @if(session('success'))
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-dark table-flush">
                        ...
                        <tr>
                            ...
                            <td>{{ $datas->contect_name }}</td>                            
                            <td>{{ $datas->contect_email }}</td>                            
                            <td>{{ $datas->contect_phone }}</td>                            
                            ...
                            <td>
                                ...
                                <span> {!! Form::open([
                                          'method'=>'DELETE',
                                          'route' => ['feedback.destroy', $datas->id],
                                          ...
                                          'class' => 'btn',
                                          'title' => 'Delete Page',
                                          'onclick'=>'return confirm("Are you sure about deleting Feedback?")'
                                          )) !!}
                                          {!! Form::close() !!}</span>
                            </td>
                        </tr>
